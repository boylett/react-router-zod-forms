 ...
 */
type Replace<Object, From, To> = Object extends From ? To : Object extends Array<infer U> ? Array<Replace<U, From, To>> : Object extends Date | RegExp | Map<any, any> | Set<any> | ((...args: any[]) => any) ? Object : Object extends Record<string, any> ? {
 ...
 */
export type SchemaPaths<SchemaType extends z.ZodObject<any>> = Paths<Replace<z.output<SchemaType>, Blob | File | FileUpload | Date, {}>, {
...
export declare namespace ZodForms {
    ...
    namespace Components {
        ...
        namespace Field {
            ...
            type Props<SchemaType extends z.ZodObject<any>, FieldPath extends SchemaPaths<SchemaType>, FieldValue = Get<z.output<SchemaType>, FieldPath>, FieldType = (FieldValue extends boolean ? "hidden" | "image" | "checkbox" | "radio" : FieldValue extends Date ? "hidden" | "image" | "date" | "datetime" | "datetime-local" | "month" | "time" | "week" : FieldValue extends File ? "hidden" | "image" | "file" : FieldValue extends number ? "hidden" | "image" | "number" | "range" : FieldValue extends Array<any> ? "select" : HTMLInputTypeAttribute | "select" | "textarea")> = Omit<FieldValue extends Array<any> ? Omit<SelectHTMLAttributes<HTMLSelectElement>, "defaultValue" | "multiple" | "value"> : Omit<InputHTMLAttributes<HTMLInputElement> & TextareaHTMLAttributes<HTMLTextAreaElement>, "defaultValue" | "value">, "children" | "name" | "type"> & {
                 ...
                 */
                children?: ReactNode | ((props: any, shape: z.ZodType | Record<string, undefined>) => ReactNode);
                /**
        ...
        namespace Form {
             ...
             */
            interface Props<SchemaType extends z.ZodObject<any>> extends FormProps {
                /**
        ...
        namespace Message {
            ...
            namespace Props {
                ...
                interface Field<SchemaType extends z.ZodObject<any>, FieldPath extends SchemaPaths<SchemaType>> extends Omit<AllHTMLAttributes<HTMLElement>, "as" | "children" | "name"> {
                     ...
                     */
                    children?: (props: any, shape: z.ZodType<Get<z.output<SchemaType>, FieldPath>, Get<z.input<SchemaType>, FieldPath>>, issues: z.core.$ZodIssue[]) => ReactNode;
                    /**
                     * The name of the field in the schema
                     */
                 ...
                 */
                interface Form<PayloadType, SchemaType extends z.ZodObject<any>> extends Omit<AllHTMLAttributes<HTMLElement>, "as" | "children" | "name"> {
                    /**
                     * The element type to render
                     *
                     * @remarks
                     ...
                     */
                    children?: (props: any, schema: SchemaType, message: ZodForms.Response<SchemaType, PayloadType>) => ReactNode;
                    /**
                     * The name of the field in the schema
                     */
                    name?: never;
    ...
    namespace Context {
        ...
        type Fetcher<DataType = any, SchemaType extends z.ZodObject<any> = z.ZodObject<any>, FieldPath extends SchemaPaths<SchemaType> = SchemaPaths<SchemaType>> = {
             ...
             * Message component
             */
            Message: (props: ZodForms.Components.Message.Props<DataType extends ZodForms.Response<SchemaType> ? DataType["payload"] : DataType, SchemaType, FieldPath>) => React.JSX.Element;
        };
        /**
    ...
    namespace Response {
         ...
         */
        type Payload<SchemaType extends z.ZodObject<any>, PayloadType = any> = {
            /**
     ...
     * The message relayed back to the browser following a handled form action
     */
    interface Response<SchemaType extends z.ZodObject<any>, PayloadType = any> {
        /**
         * The submitted form intent
         */
        intent: string;
    ...
    namespace UseZodForm {
        ...
        namespace Options {
             ...
             * Options for the useZodForms hook
             */
            interface Fetcher<SchemaType extends z.ZodObject<any>, Intent extends keyof z.output<SchemaType["_zod"]["def"]["shape"]>> {
                /**
                 * Configure which events trigger validation
                 *
                 * @remarks
            ...
            * Options for the useZodForms hook
            */
            interface Form<SchemaType extends z.ZodObject<any>, Intent extends keyof z.output<SchemaType["_zod"]["def"]["shape"]>> {
                /**
                 * Configure which events trigger validation
                 *
                 * @remarks
         ...
         * Options for the useZodForms hook
         */
        type Options<SchemaType extends z.ZodObject<any>, Intent extends keyof z.output<SchemaType["_zod"]["def"]["shape"]>> = ZodForms.UseZodForm.Options.Fetcher<SchemaType, Intent> | ZodForms.UseZodForm.Options.Form<SchemaType, Intent>;
    }
    /**
     * Return type of the useZodForm hook
     */
